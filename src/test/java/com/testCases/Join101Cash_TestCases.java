...
public class Join101Cash_TestCases extends base {
	...
	@Test
	public void Join101Cash() throws InterruptedException {
		...
		LobbyFilter_TC.pools().click();
		log.info("Click on Pools Games");
		...
		log.info("********************101 Six Player Table Joined*****************************************************");
		joinTable(prop.getProperty("101_Sixplayer"));
		log.info("********************101 Six Player Table Left*****************************************************");
		log.info("");
		...
		log.info("********************101 Two Player Table Joined*****************************************************");
		joinTable(prop.getProperty("101_Twoplayer"));
		log.info("********************101 Two Player Table Left*****************************************************");
		log.info("");
	...
	public void joinTable(String betvalue ) {
		...
		do {
			...
			List<WebElement> GameType = driver.findElements(By.cssSelector(".level1.ng-binding.ng-scope"));
			
			//List<String> gameType = GameType.stream().map(s->s.getText()).collect(Collectors.toList());
