...
public class PracticeOneShot_TestCases extends base {
	...
	@Test
	public void JoinOneShot() throws InterruptedException {
		...
		LobbyFilter_TC.oneshots().click();
		log.info("Click on OneShot Games");
		...
		log.info("********************OneShot Six Player Table Joined*****************************************************");
		joinTable(prop.getProperty("PracticeOneShot_Sixplayer"));
		log.info("********************OneShot Six Player Table Left*****************************************************");
		log.info("");
		...
		log.info("********************OneShot Two Player Table Joined*****************************************************");
		joinTable(prop.getProperty("PracticeOneShot_Twoplayer"));
		log.info("********************OneShot Two Player Table Left*****************************************************");
		log.info("");
