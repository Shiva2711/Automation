...
public class PracticeBO3_TestCases2 extends base {
	...
	@Test
	public void JoinBO3() throws InterruptedException {
		...
		log.info("********************Best of 3 Table Joined*****************************************************");
		joinTable(prop.getProperty("PracticeBO3"));
		log.info("********************Best of 3 Player Table Left*****************************************************");
		log.info("");
