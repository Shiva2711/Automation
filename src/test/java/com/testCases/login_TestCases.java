...
public class login_TestCases extends base {
	...
	public void Login() throws IOException {
		...
		softAssert.assertEquals(LoginValidation_TC.getUsernameErrorText().getText(), "Enter Username");
		log.info("Enner Username Alert Display");
		softAssert.assertEquals(LoginValidation_TC.getPasswordErrorText().getText(), "Enter Password");
		log.info("Enner Password Alert Display");
		
		LoginValidation_TC.clearAll();
		LoginValidation_TC.getUsernameandPassword("Test", "Demo");
		softAssert.assertEquals(LoginValidation_TC.getInvalidLoginErrorText().getText(), "Invalid Username and Password");
