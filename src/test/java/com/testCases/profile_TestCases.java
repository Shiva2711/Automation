...
public class profile_TestCases extends base {
	...
	public void Profile() throws IOException {
		  ...
		  profile_TC.gotoProfile(); log.info("Clicked on the Profile Link");
		  ...
		  profile_TC.clearAll(); log.info("All filed data cleared");
		  
		  profile_TC.validFirstandLastName("Test", "Demo");
		  log.info("Valid First name and Last name entered");
		  
		  profile_TC.selectGenderMale(); log.info("Selected Gender Male");
		  
		  profile_TC.selectGenderFemale(); log.info("Selected Gender Female");
		  
		  profile_TC.validAddress1("No: 203"); log.info("Entered Address 1");
		  
		  profile_TC.validAddress2("Gandhi Street"); log.info("Entered Address 2");
		  
		  profile_TC.validLandMark("Bus Stop Back side"); log.info("Entered Landmark");
		  
		  profile_TC.country(); log.info("Country India is displayed");
		  ...
		  profile_TC.validPincode("123456"); log.info("Entered valid Pincode");
		  
		  profile_TC.submitProfile(); log.info("Submited the Profile");
