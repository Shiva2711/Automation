...
public class Join201Cash_TestCases extends base {
	...
	@Test
	public void Join201Cash() throws InterruptedException {
		...
		log.info("********************201 Six Player Table Joined*****************************************************");
		joinTable(prop.getProperty("201_Sixplayer"));
		log.info("********************201 Six Player Table Left*****************************************************");
		log.info("");
		...
		log.info("********************201 Two Player Table Joined*****************************************************");
		joinTable(prop.getProperty("201_Twoplayer"));
		log.info("********************201 Two Player Table Left*****************************************************");
		log.info("");
